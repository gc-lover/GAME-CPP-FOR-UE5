...
Прослойка между бекендом BACK-JAVA (Java Spring Boot) и Unreal Engine 5 для проекта NECPGAME.

## Описание

Репозиторий `GAME-CPP-FOR-UE5` содержит интеграцию между игровым движком Unreal Engine 5 и бекенд сервисом BACK-JAVA (Java Spring Boot). Предоставляет C++ интерфейс для работы с игровым сервером.
...
- **REST API Client** - подключение к BACK-JAVA (Java Spring Boot) через REST
...
1. Реализация клиента для подключения к BACK-JAVA (Java Spring Boot)
